...
This stripped build does not bundle extra skills, dashboards, or project-specific overlays. Prefer precise browser commands, stable refs from snapshots, and explicit verification after significant actions."#,
        )
    })
}
